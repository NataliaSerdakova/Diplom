...
class AppActivityTest4 {
    ...
    fun appActivityTest4() {
        ...
        val textInputEditText = onView(
            allOf(
                withId(R.id.news_item_publish_time_text_input_edit_text), withText("15:10"),
                childAtPosition(
                    childAtPosition(
        ...
        val appCompatEditText = onView(
            allOf(
                withClassName(`is`("androidx.appcompat.widget.AppCompatEditText")), withText("18"),
                childAtPosition(
                    allOf(
        ...
        val appCompatEditText3 = onView(
            allOf(
                withClassName(`is`("androidx.appcompat.widget.AppCompatEditText")), withText("2"),
                childAtPosition(
                    allOf(
                        withClassName(`is`("android.widget.RelativeLayout")),
                        childAtPosition(
        ...
        appCompatEditText3.perform(replaceText("26"))

        val appCompatEditText4 = onView(
            allOf(
                withClassName(`is`("androidx.appcompat.widget.AppCompatEditText")), withText("26"),
                childAtPosition(
                    allOf(
                        withClassName(`is`("android.widget.RelativeLayout")),
                        childAtPosition(
        ...
        textView2.check(matches(withText("Enter a valid time")))
    }
